...
[![MicroBadger Layers](https://img.shields.io/microbadger/layers/linuxserver/dillinger.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge)](https://microbadger.com/images/linuxserver/dillinger "Get your own version badge on microbadger.com")
...
Simply pulling `ghcr.io/linuxserver/dillinger` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' ghcr.io/linuxserver/dillinger`
...
* Update the image: `docker pull ghcr.io/linuxserver/dillinger`
...
docker build \
  --no-cache \
  --pull \
  -t ghcr.io/linuxserver/dillinger:latest .
```
