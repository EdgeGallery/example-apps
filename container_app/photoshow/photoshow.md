...
[![MicroBadger Layers](https://img.shields.io/microbadger/layers/linuxserver/photoshow.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge)](https://microbadger.com/images/linuxserver/photoshow "Get your own version badge on microbadger.com")
...
* Update the image: `docker pull ghcr.io/linuxserver/photoshow`
...
docker build \
  --no-cache \
  --pull \
  -t ghcr.io/linuxserver/photoshow:latest .
```
